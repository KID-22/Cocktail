...
parser.add_argument("--model", type=str, help="retrieval model", default="dragon")
...
model = DRES(models.SentenceBERT((
    ...
    "nthakur/dragon-roberta-context-encoder")), batch_size=args.batch_size)
model.model.q_model.max_seq_length = 512
model.model.doc_model.max_seq_length = 512
