...
from benchmark.beir.reranking.models import MonoT5
...
parser.add_argument("--model", type=str, help="retrieval model", default="castorini/monot5-base-msmarco-10k")
...
# 1. 'castorini/monot5-small-msmarco-100k':             ['▁false', '▁true']
# 2. 'castorini/monot5-base-msmarco':         ['▁false', '▁true']
# 3. 'castorini/monot5-large-msmarco':            ['▁false', '▁true']
# 4. 'castorini/monot5-3b-msmarco':        ['▁false', '▁true']
# 5. 'castorini/monot5-small-msmarco-10k':             ['▁false', '▁true']
# 6. 'castorini/monot5-base-msmarco-10k':         ['▁false', '▁true']
# 7. 'castorini/monot5-large-msmarco-10k':            ['▁false', '▁true']
# 8. 'castorini/monot5-3b-msmarco-10k':        ['▁false', '▁true']

cross_encoder_model = MonoT5(f'{args.model}', use_amp=False, token_false='▁false', token_true='▁true')
