...
class GenericDataLoader:
    ...
    def __init__(self, data_folder: str = None, prefix: str = None, corpus_file: str = "corpus.jsonl", query_file: str = "queries.jsonl", 
                 qrels_folder: str = "qrels", qrels_file: str = "", corpus_source: str = "", ignore_title: bool = True):
        self.corpus = {}
        self.queries = {}
        self.qrels = {}
    ...
    def _load_corpus(self):
        ...
        with open(self.corpus_file, encoding='utf8') as fIn:
            for line in tqdm(fIn, total=num_lines):
                ...
                self.corpus[line.get("_id") + self.corpus_source] = {
                    "text": line.get("text"),
                    "title": line.get("title") if not self.ignore_title else "",
                }
